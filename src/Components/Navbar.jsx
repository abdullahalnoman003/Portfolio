...
const Navbar = () => {
  ...
  <div className="navbar-start ">
    ...
    <Link to='hero' smooth={true} duration={500} className="btn max-lg:pl-0 bg-transparent shadow-none border-0 text-2xl max-lg:text-xl font-bold lg:ml-4"> <span className='text-primary'>Noman</span><span>Dev</span> </Link>
  </div>
  ...
  <div className="navbar-end">
    <a className="btn btn-primary  ml-3 mr-3"><FaDownload/>Resume</a>
  </div>
</div>
    );
};
