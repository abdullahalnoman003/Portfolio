  ...
  return (
    ...
    >
      <div className="text-center">
        <motion.h2
          className="text-4xl font-extrabold mb-6 inline-block bg-clip-text  text-primary"
        ...
        <div className="flex flex-col md:flex-row justify-center gap-8">
          <div className="bg-[#1e1e2f] rounded-2xl p-6 shadow-lg hover:scale-105 hover:shadow-purple-500/100 shadow-purple-500/40 backdrop-blur transition-all duration-300">
          ...
          <div className="bg-[#1e1e2f] rounded-2xl p-6 shadow-lg hover:scale-105 transition-all hover:shadow-purple-500/100 shadow-purple-500/40  backdrop-blur duration-300">
          ...
          <div className="bg-[#1e1e2f] rounded-2xl p-6 shadow-lg hover:scale-105 transition-all hover:shadow-purple-500/100 duration-300 shadow-purple-500/40 backdrop-blur">
